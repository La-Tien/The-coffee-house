...
if (isset($_GET['act'])) {
    ...
    switch ($act) {
        ...
        case 'list_product':
            ...
            $list_category = loadall_category();
            $list_products = loadall_products($kyw, $id_category,$page=0);
        ...
        case 'update_users':
            if (isset($_POST['update'])) {
                ...
                $role = $_POST['role'];
                $id = $_POST['id'];
                update_account_admin($id, $user, $first_name, $last_name, $email, $address, $country, $town_city, $phone_number, $role);
            }
            $list_account = loadall_account();
            include "./pages/account/list_user.php";
            break;
        ...
        case 'add_bill':
            if (isset($_POST['account']) && ($_POST['account'])) {
                ...
                echo "<script>
                            window.location.href='index.php?act=add_bill';
                      </script>";
                $notification = "More success";
            }
