                        ...
                        foreach ($list_products as $product) {
                            ...
                            echo '
                                    <tr>
                                       ...
                                       <td class="text-center"><a href="' .  $update_products . '"><input class="btn btn-gradient-primary btn-fw" type="button" value="Update"></a> <a onclick=\'return confirm("you definitely want to delete ??!");\' href="' . $delete_products . '" ><input class="btn btn-gradient-danger btn-fw" type="button" value="Delete"></a></td>
                                   </tr>
                                       ';
                        }
                        ?>
