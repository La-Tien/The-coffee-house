<div class="col-lg-10 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <a href="index.php?act=checkout_bill" class="btn btn-gradient-primary btn-fw">Continue to pay</a>
            <a href="index.php?act=add_product_bill" class="btn btn-gradient-primary btn-fw">keep ordering</a>
            <hr class="my-2">
                    ...
                    <tbody>
                        ...
                        foreach ($_SESSION['mycart_bill'] as $cart) {
                            ...
                            echo '
                                       ...
                                       <td class="text-center"> <a onclick=\'return confirm("you definitely want to delete ??!");\' href="' . $delete_products . '" ><input class="btn btn-gradient-danger btn-fw" type="button" value="Delete"></a></td>
