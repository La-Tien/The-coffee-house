                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="index.php?act=update_users" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="password" value="<?= $password ?>" class="form-control" id="exampleInputCity1" placeholder="Password">
                        </div>
                        <div class="form-group">
                        ...
                        <input type="submit" name="update" class="btn btn-gradient-primary me-2" value="Update"></input>
                    </form>
                </div>
            </div>
        </div>
