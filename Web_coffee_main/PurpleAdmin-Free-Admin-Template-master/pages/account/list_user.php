                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        foreach ($list_account as $account) {
                            ...
                            <td class="text-center"><a href="' . $delete_account . '"><input type="button" class="btn btn-gradient-danger btn-fw" value="delete"></a> <a href="' . $update_account . '"><input type="button" class="btn btn-gradient-primary btn-fw" value="update"></a></td>
