              ...
              <div class="card" style="border-radius: 1rem;">
                <div class="row g-0">
                  <div class="col-md-8 col-lg-5 d-none d-md-block">
                    <img src="view/img/nathan-dumlao-zUNs99PGDg0-unsplash.jpg"
                  ...
                  <div class="col-md-4 col-lg-7 d-flex align-items-center">
                    <div class="card-body p-4 p-lg-5 text-black">
                      ...
                      <form action="index.php?act=login" method="post">
                        ...
                        <div class="pt-1 mb-4">
                          <input name="login" value="login now"  class="btn btn-dark btn-lg btn-block" type="submit">
                        </div>
      
                        <a class="small text-muted" href="index.php?act=forgot_password">Forgot password?</a>
                        <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="index.php?act=register"
